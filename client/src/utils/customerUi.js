...
export function isUnsetCustomerValue(value) {
...
export function displayCustomerLabel(value) {
    const n = customerFieldToForm(value);
    return n || "—";
}
export function customerFieldsToApi(fields) {
