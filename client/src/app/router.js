    ...
    return (_jsxs("div", { className: "min-h-screen bg-blue-950", children: [_jsxs("header", { className: "relative overflow-hidden border-b border-cyan-500/25 bg-gradient-to-br from-blue-950 via-[#0a1628] to-blue-950 shadow-[0_12px_40px_-8px_rgba(8,47,73,0.85)]", children: [_jsx("div", { className: "pointer-events-none absolute inset-0 opacity-[0.4]", style: {
                            backgroundImage: "radial-gradient(ellipse 80% 60% at 20% -20%, rgba(34, 211, 238, 0.22), transparent 55%), radial-gradient(ellipse 70% 50% at 100% 0%, rgba(14, 165, 233, 0.18), transparent 50%)"
                                                ...
                                                isActive
                                                    ? "border-cyan-400/55 bg-gradient-to-br from-blue-900 to-blue-950 text-white shadow-[0_8px_30px_-6px_rgba(34,211,238,0.35)] ring-2 ring-cyan-400/35"
                                                    : "border-blue-800/70 bg-blue-950/80 text-blue-100/85 hover:border-cyan-600/35 hover:bg-blue-900/70 hover:text-white"
                                            ].join(" "), children: [_jsx(SalesIcon, { className: "h-7 w-7 shrink-0 opacity-90" }), _jsx("span", { children: "Ventas" })] })] })] }) })] }), _jsx("main", { className: "mx-auto max-w-7xl p-4 sm:p-6 md:p-8", children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(InventoryPage, {}) }), _jsx(Route, { path: "/builds", element: _jsx(BuildsPage, {}) }), _jsx(Route, { path: "/builds/:id", element: _jsx(BuildDetailPage, {}) }), _jsx(Route, { path: "/sales", element: _jsx(SalesPage, {}) }), _jsx(Route, { path: "/sales/:id", element: _jsx(SaleDetailPage, {}) }), _jsx(Route, { path: "/services", element: _jsx(ServicesPage, {}) })] }) })] }));
}
