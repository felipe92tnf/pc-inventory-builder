...
export function SalesPage() {
    ...
    const deliveredPcSalesInMonth = useMemo(() => salesInSelectedMonth.filter((s) => s.pickupConfirmedAt != null), [salesInSelectedMonth]);
    const pendingPickupPcSalesInMonth = useMemo(() => salesInSelectedMonth.filter((s) => s.pickupConfirmedAt == null), [salesInSelectedMonth]);
    useEffect(() => {
        let active = true;
