...
function SalesOverviewSection({ title, subtitle, count, totalRevenue, totalProfit, open, onToggle, desktopTable, mobileCards }) {
    return (_jsxs("article", { className: "overflow-hidden rounded-xl border border-slate-800 bg-slate-950/40", children: [_jsxs("button", { type: "button", onClick: onToggle, className: "flex w-full items-center justify-between gap-3 px-4 py-3 text-left", "aria-expanded": open, children: [_jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "font-semibold text-slate-100", children: title }), _jsx("p", { className: "text-xs text-slate-500", children: subtitle }), _jsxs("div", { className: "mt-2 flex flex-wrap gap-2", children: [_jsxs("span", { className: "inline-flex rounded-full border border-indigo-500/40 bg-indigo-500/15 px-2.5 py-1 text-xs font-semibold text-indigo-200", children: [count, " registro", count === 1 ? "" : "s"] }), _jsxs("span", { className: "inline-flex rounded-full border border-cyan-500/40 bg-cyan-500/15 px-2.5 py-1 text-xs font-semibold text-cyan-200", children: ["Venta ", money(totalRevenue)] }), _jsxs("span", { className: `inline-flex rounded-full border px-2.5 py-1 text-xs font-semibold ${totalProfit >= 0
                                            ? "border-emerald-500/40 bg-emerald-500/15 text-emerald-200"
                                            : "border-rose-500/40 bg-rose-500/15 text-rose-200"}`, children: ["Beneficio ", money(totalProfit)] })] })] }), _jsx(ChevronSales, { open: open })] }), open ? (_jsx("div", { className: "border-t border-slate-800 p-3", children: count === 0 ? (_jsx("p", { className: "text-sm text-slate-500", children: "Sin registros en este periodo." })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "hidden overflow-x-auto rounded-lg border border-slate-800 md:block", children: desktopTable }), _jsx("div", { className: "space-y-2 md:hidden", children: mobileCards })] })) })) : null] }));
}
