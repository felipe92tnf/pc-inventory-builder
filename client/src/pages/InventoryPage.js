...
function parseInventoryTab(value) {
    if (!value)
        return null;
    const allowed = ["summary", "stock", "catalog", "services", "components", "prebuilt"];
