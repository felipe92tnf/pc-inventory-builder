...
export function BuildDetailPage() {
    ...
    if (loading) {
        return (_jsx("section", { className: "rounded-2xl border border-slate-800 bg-slate-900/80 p-6 shadow-lg shadow-slate-950/40", children: _jsx("p", { className: "text-sm text-slate-300", children: "Cargando detalle del montaje..." }) }));
    }
    if (!build) {
    ...
    return (_jsxs("div", { className: "mx-auto w-full max-w-7xl space-y-6 px-2 pb-8 text-slate-100 md:px-4", children: [_jsxs("section", { className: "rounded-2xl border border-slate-800 bg-gradient-to-r from-slate-950 via-slate-900 to-indigo-950 p-6 shadow-[0_20px_50px_-24px_rgba(79,70,229,0.75)]", children: [_jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold", children: build.name }), _jsx("p", { className: "mt-1 text-sm text-slate-300", children: build.notes || "Sin descripcion." })] }), _jsxs("div", { className: "flex flex-wrap items-center justify-end gap-2", children: [build.status === "CONFIRMED" ? (_jsx("button", { type: "button", disabled: actionLoading, onClick: () => {
                    ...
                    : undefined }), _jsx("section", { className: "rounded-2xl border border-slate-800 bg-slate-900/80 p-5 shadow-lg shadow-slate-950/40", children: _jsxs("div", { className: "flex flex-col gap-4 md:flex-row md:items-center md:justify-between", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-lg font-semibold text-slate-100", children: "Confirmar montaje" }), _jsx("p", { className: "text-sm text-slate-300", children: build.status === "SOLD"
                                        ...
                                        void confirm();
                                    }, className: "rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-900/40 transition hover:bg-emerald-500 disabled:cursor-not-allowed disabled:opacity-50", children: build.status === "SOLD"
                                        ? "Vendido"
                                        : build.status === "CONFIRMED"
                                            ? "Montaje confirmado"
                                            : actionLoading
