...
import { PRIMARY_ACTION_BUTTON, PRIMARY_ACTION_BUTTON_HEADER, STICKY_PRIMARY_MOBILE_DOCK, SECONDARY_GHOST_SM, DESTRUCTIVE_BUTTON_SM, FILTER_TOGGLE_ROW } from "../theme/actionButtons";
...
export function QuotesPage() {
    ...
    const handleDelete = async (quote) => {
        const ok = window.confirm(`Eliminar el presupuesto #${quote.quoteNumber} "${quote.title}"?\n\nEsta accion no se puede deshacer.`);
        if (!ok)
            return;
