...
export function SaleDetailPage() {
    ...
    return (_jsxs("div", { className: PAGE_OUTER_7XL, children: [_jsxs("section", { className: PAGE_HERO, children: [_jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2.5", children: [_jsxs("div", { children: [_jsxs("h1", { className: "text-2xl font-bold tracking-tight", children: ["Venta \u00B7 ", b.name] }), _jsxs("p", { className: "mt-1 text-sm text-slate-300", children: ["Cliente: ", _jsx("span", { className: "font-medium text-slate-100", children: sale.customerName })] })] }), sale.pickupConfirmedAt == null ? (_jsx(StatusBadge, { variant: "pending", size: "detail", children: "Cobrado \u00B7 pendiente de recogida" })) : (_jsx(StatusBadge, { variant: "sold", size: "detail", children: "Entregado" }))] }), _jsxs("div", { className: "mt-4 flex flex-wrap gap-2", children: [_jsx(Link, { to: "/sales", className: "rounded-full border border-slate-600 bg-slate-950/60 px-3 py-1 text-xs font-medium text-slate-200 hover:bg-slate-800", children: "Ventas" }), _jsx(Link, { to: `/builds/${b.id}`, className: "rounded-full border border-slate-600 bg-slate-950/60 px-3 py-1 text-xs font-medium text-slate-200 hover:bg-slate-800", children: "Montaje" }), _jsx(CustomerProfileLink, { customerName: sale.customerName, customerPhone: sale.customerPhone, className: "rounded-full border border-slate-600 bg-slate-950/60 px-3 py-1 text-xs font-medium text-indigo-200 hover:bg-slate-800", children: "Ficha cliente" }), sale.paymentMethod ? (_jsx(StatusBadge, { variant: "meta", size: "detail", className: "font-medium", children: sale.paymentMethod })) : null, sale.warrantyMonths != null ? (_jsxs(StatusBadge, { variant: "completed", size: "detail", className: "font-medium", children: ["Garantia ", sale.warrantyMonths, " meses"] })) : null] })] }), error ? (_jsxs("div", { className: "rounded-xl border border-rose-800/70 bg-rose-950/40 px-4 py-3 text-sm text-rose-200", children: [error, _jsx("button", { type: "button", onClick: () => {
                            ...
                            void handleConfirmPickup();
                                        ...
                                        }, className: "rounded-lg border border-rose-500/50 bg-rose-500/10 px-4 py-2 text-sm font-semibold text-rose-200 transition hover:bg-rose-500/20 disabled:opacity-50", children: "Eliminar venta" })] })] })] }), _jsxs("section", { children: [_jsx("h2", { className: "mb-3 text-sm font-semibold uppercase tracking-wider text-slate-400", children: "Piezas del montaje" }), _jsx(BuildItemsTable, { items: b.items, status: "SOLD", actionLoading: false, onRemove: async () => { } }), _jsx("p", { className: "mt-2 text-xs text-slate-500", children: "Referencia del configuracion vendido; no se pueden modificar lineas desde aqui." })] }), (b.extraLines?.length ?? 0) > 0 ? (_jsxs("section", { className: "mt-8", children: [_jsx("h2", { className: "mb-3 text-sm font-semibold uppercase tracking-wider text-slate-400", children: "Extras del montaje" }), _jsx(BuildExtraLinesTable, { lines: b.extraLines ?? [], status: "SOLD", actionLoading: false, onRemove: async () => { } })] })) : null] }));
}
