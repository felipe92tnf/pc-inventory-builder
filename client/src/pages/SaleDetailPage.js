...
import { StatusBadge, collectionPaymentVariant } from "../components/ui/StatusBadge";
...
export function SaleDetailPage() {
    ...
    const { sale, loading, saving, error, reload, updateSale, registerPayment, removeSale } = useSaleDetail(saleId);
