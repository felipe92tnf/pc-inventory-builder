 ...
 */
export const STICKY_PRIMARY_MOBILE_DOCK =
  "fixed inset-x-0 bottom-0 z-40 border-t border-slate-800/90 bg-slate-950/95 px-3 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur md:hidden";
...
export const FILTER_TOGGLE_ROW =
  "flex w-full cursor-pointer list-none items-center justify-between gap-3 rounded-xl border border-slate-700 bg-slate-950/40 px-4 py-2.5 text-left text-sm font-semibold text-slate-200 transition hover:border-slate-600 hover:bg-slate-900/60";
...
export const ORANGE_EDIT_BUTTON_SM =
  "inline-flex items-center justify-center rounded-lg border border-orange-500/55 bg-orange-500/15 px-3 py-1.5 text-xs font-semibold text-orange-100 transition hover:border-orange-400/70 hover:bg-orange-500/25 disabled:opacity-50";

export const ORANGE_EDIT_BUTTON_CARD =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-lg border border-orange-500/55 bg-orange-500/15 px-4 py-2.5 text-sm font-semibold text-orange-100 transition hover:border-orange-400/70 hover:bg-orange-500/25 disabled:cursor-not-allowed disabled:opacity-50";
