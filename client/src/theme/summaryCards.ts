...
const SUMMARY_CARD_BASE =
  "flex flex-col rounded-2xl border border-cyan-500/25 bg-gradient-to-br from-[#0a0f1a] via-[#0c1424] to-[#081018] p-5 shadow-[0_12px_40px_-16px_rgba(6,182,212,0.18)] ring-1 ring-cyan-500/10";
...
export const SUMMARY_CARD_LABEL =
  "text-[11px] font-semibold uppercase tracking-wider text-cyan-100/50";

/** Número principal (combinar con una clase de color). */
export const SUMMARY_CARD_VALUE =
  "mt-2 text-2xl font-bold tabular-nums leading-tight tracking-tight md:text-[1.65rem]";
