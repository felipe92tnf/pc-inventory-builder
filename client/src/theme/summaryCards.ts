...
const SUMMARY_CARD_BASE =
  "flex flex-col rounded-2xl border border-cyan-500/25 bg-gradient-to-br from-[#0a0f1a] via-[#0c1424] to-[#081018] p-2.5 shadow-[0_12px_40px_-16px_rgba(6,182,212,0.18)] ring-1 ring-cyan-500/10 sm:p-4";
...
export const SUMMARY_CARD_LABEL =
  "text-[10px] font-semibold uppercase tracking-wider text-cyan-100/50 sm:text-[11px]";

/** Número principal (combinar con una clase de color). */
export const SUMMARY_CARD_VALUE =
  "mt-1 text-xl font-bold tabular-nums leading-tight tracking-tight sm:mt-1.5 sm:text-2xl md:text-[1.6rem]";
...
export const SUMMARY_CARD_GRID =
  "grid grid-cols-2 gap-2 sm:gap-2.5 xl:grid-cols-4";

/** Variante 3 columnas (detalle montaje / venta): 2 col móvil, 3 desde md. */
export const SUMMARY_CARD_GRID_THREE =
  "grid grid-cols-2 gap-2 sm:gap-2.5 md:grid-cols-3";
